      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('theme');if(t==='light'){document.documentElement.classList.remove('dark')}else{document.documentElement.classList.add('dark')}var b=localStorage.getItem('bgMode');document.documentElement.setAttribute('data-bg-mode',b==='animated'?'animated':'realistic');}catch(e){}})();`,
          }}
        />
      </head>
