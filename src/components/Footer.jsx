...
const Footer = () => {
  return (
    <footer className="w-full border-t border-gray-200/30 dark:border-gray-800/30 backdrop-blur-md bg-[var(--bg)]/20 dark:bg-[var(--bg)]/30">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            <Link
              ...
              className="text-sm text-black dark:text-white hover:text-black dark:hover:text-white transition"
            >
          ...
          <div className="flex items-center gap-4">
            <Link href="https://github.com/Solohater" target="_blank" aria-label="GitHub">
              <svg className="w-5 h-5 opacity-60 hover:opacity-100 transition text-black dark:text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="https://www.linkedin.com/in/yoseph-ayalew-65247b291" target="_blank" aria-label="LinkedIn">
              <svg className="w-5 h-5 opacity-60 hover:opacity-100 transition text-black dark:text-white" fill="currentColor" viewBox="0 0 24 24">
