      ...
      <AnimatePresence>
        {menuOpen && (
          <>
            ...
            {/* Solid High-Visibility Mobile Menu Panel */}
            <motion.div
            ...
            >
              <div className="p-4 flex flex-col gap-1.5">
                <div className="flex items-center justify-between px-3 py-2 mb-1 border-b border-[var(--border)]">
                ...
                <div className="mt-2 pt-3 border-t border-[var(--border)] flex items-center justify-between px-2 gap-2">
                  <div className="flex items-center gap-2">
                    <a
                      ...
                      className="p-2.5 rounded-xl bg-black/5 dark:bg-white/10 hover:bg-black/10 dark:hover:bg-white/20 transition-colors"
